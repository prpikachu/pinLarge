...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	feeds := strings.Replace(feedr, "<description></description>", "<description></description>", -1)
	//replace all titles
	...
	feedl := strings.Replace(feedk, "</description1><pubDate>", "titulo</title><pubDate>", -1)
	//restore description
	...
	feedo := strings.Replace(feedn, "<channel>", "<channel><title>Pinterest Large Image Feed</title>", -1)
